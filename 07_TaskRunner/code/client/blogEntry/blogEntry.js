(function (angular) {
	...
	.controller('blogEntriesCtrl', ["$scope", "$location", "BlogEntry", function($scope, $location, BlogEntry) {
	...
	.controller('blogEntryCtrl', ["$scope", "$stateParams", "BlogEntry", function($scope, $stateParams, BlogEntry){
